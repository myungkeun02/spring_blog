...
import org.myungkeun.spring_blog.exception.ResourceNotFoundException;
import org.myungkeun.spring_blog.payload.PostDto;
import org.myungkeun.spring_blog.payload.PostsResponseDto;
import org.myungkeun.spring_blog.repositories.PostRepository;
...
public class PostServiceImpl implements PostService {
    ...
    public PostsResponseDto getAllPost(int pageNo, int pagezSize, String sortBy, String sortDir) {
        ...
        Pageable pageable = PageRequest.of(pageNo - 1, pagezSize, sort);
